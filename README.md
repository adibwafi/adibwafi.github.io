...
3. **Curated Work & Case Studies**: Asymmetrical card layouts with live WebP mockups, architectural summaries, repository links, and live demo triggers for production systems including **Kinghouse Management** (Short-Stay Hospitality ERP & Dynamic Pricing), **Lotus Semarang** (Accessible Modern Wellness Web App & Turborepo Monorepo), **Amana Care** (Daycare & Working Space), **Serasa Kreatif Platform** (Creative Agency Storefront), **Enterprise LMS Architecture Blueprint**, **AI Baby Meal Planner**, and **Livecode Logic Trainer**.
