export const translations = {
  en: {
    ...
    work: {
      ...
      desc: 'Selected repositories spanning developer tooling, enterprise infrastructure, consumer product engineering, premium daycare services, and creative agency platforms.',
    ...
    videography: {
      ...
      archiveDesc: 'The complete list of eleven productions across commercial, aviation, automotive, and lifestyle work.',
      ...
      principlesLabel: 'Behind the Lens',
      principlesTitle: 'Principles that carried over.',
      principles: [
        {
  ...
  id: {
    ...
    work: {
      ...
      desc: 'Portofolio repositori utama yang mencakup developer tools, infrastruktur skala enterprise, rekayasa produk konsumen, layanan daycare eksklusif, serta platform agensi kreatif.',
      openSourceLabel: 'Open Source',
      ...
      openSourceBtn: 'Lihat Profil GitHub',
    ...
    videography: {
      ...
      archiveDesc: 'Daftar lengkap sebelas produksi mencakup karya komersial, aviasi, otomotif, dan gaya hidup.',
      ...
      principlesLabel: 'Di Balik Lensa',
      principlesTitle: 'Prinsip yang tetap terpakai.',
      principles: [
        {
